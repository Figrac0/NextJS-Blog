...
export const translations = {
    en: {
        ...
        selectNewest: "Select sort option",
        ...
        footerDescription:
            "Have a project in mind? Let's connect and discuss how we can create something extraordinary.",
        connectWithMe: "Connect with me",
        quickLinks: "Quick Links",
        madeWith: "Made with passion and",
        ...
        // Footer stats (добавьте если нужно)
        ...
        downloadCV: "Download CV", // если будете добавлять CV
    ...
    ru: {
        ...
        selectNewest: "Выберите сортировку",
        ...
        // Footer
        footerTitle: "Давайте создадим что-то удивительное вместе",
        footerDescription:
            "Есть проект в мыслях? Давайте обсудим, как мы можем создать что-то необыкновенное.",
        connectWithMe: "Связаться со мной",
        quickLinks: "Быстрые ссылки",
        madeWith: "Сделано с любовью и",
        ...
        // Footer CTA
        letsTalk: "Обсудить проект",
        availableForWork: "Открыт для работы",
        downloadCV: "Скачать резюме", // если будете добавлять CV
    },
};
